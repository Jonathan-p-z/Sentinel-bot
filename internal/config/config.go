...
func applyEnv(cfg *Config) {
	...
	cfg.Stripe.PriceIDPro = envString("STRIPE_PRICE_PRO", cfg.Stripe.PriceIDPro)
	cfg.Stripe.PriceIDBusiness = envString("STRIPE_PRICE_BUSINESS", cfg.Stripe.PriceIDBusiness)
	cfg.Stripe.PriceIDEnterprise = envString("STRIPE_PRICE_ENTERPRISE", cfg.Stripe.PriceIDEnterprise)
